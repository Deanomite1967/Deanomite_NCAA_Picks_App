...
def train_multiweek_model_ncaaf(up_to_week):
    ...
    # Debug
    st.write("TSRS-related columns:", [c for c in season_df.columns if "TSRS" in c])
    st.write("SEASON_DF COLUMNS AFTER MERGE:", season_df.columns.tolist())
    st.dataframe(season_df.head())
