...
def get_week_picks_singleweek_ncaaf(week_number):
    ...
    # ---------------------------------------------------------
    # RAW MODEL USING YOUR WEIGHTED DIFFS (NO TRAINING)
    # ---------------------------------------------------------
    # This is the correct replacement for the RandomForest.
    # It uses YOUR weighted diffs exactly as you defined them.
    # ---------------------------------------------------------
    feats["model_pred"] = (
          feats["tsrs_diff"]
        + feats["osrs_diff"]
