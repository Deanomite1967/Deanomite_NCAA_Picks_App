...
# --- Rename offense scoring ---
off = off.rename(columns={
    "Pts": "Pts_off"
})

# --- Rename defense scoring ---
defn = defn.rename(columns={
    "Pts": "Pts_def"
})

# --- Merge metrics first (TSRS, OSRS, DSRS, PYPA, RYPA) ---
team = (
    met
    .merge(off[["School", "Pts_off"]], on="School", how="left")
    .merge(defn[["School", "Pts_def"]], on="School", how="left")
)
