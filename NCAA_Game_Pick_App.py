...
def predict_games_ncaaf(feats):
    ...
    # Break out terms explicitly
    feats["term_tsrs"] = feats["tsrs_diff"]    * 0.30
    feats["term_osrs"] = feats["osrs_diff"]    * 0.10
    feats["term_dsrs"] = feats["dsrs_diff"]    * 0.10
    feats["term_pypa"] = feats["pypa_diff"]    * 0.15
    feats["term_rypa"] = feats["rypa_diff"]    * 0.15
    feats["term_off"]  = feats["adj_off_diff"] * 0.40
    feats["term_def"]  = feats["adj_def_diff"] * 0.40
    feats["term_sos"]  = feats["sos_diff_norm"] * 0.30
