...
def train_multiweek_model_ncaaf(up_to_week):
    ...
    st.write("TEAM NAMES:", season_df["Team"].unique())
    st.write("OPP NAMES:", season_df["Opp"].unique())
    st.write("SCHOOL NAMES:", team_master_ncaaf["School"].unique())

    season_df["Team"] = season_df["Team"].str.strip().str.lower()
    season_df["Opp"]  = season_df["Opp"].str.strip().str.lower()

    # 🔍 DIAGNOSTIC GOES HERE
    st.write("UNIQUE TEAM NAMES IN SEASON_DF:", season_df["Team"].unique())
    st.write("UNIQUE OPP NAMES IN SEASON_DF:", season_df["Opp"].unique())
    st.write("UNIQUE SCHOOL NAMES IN TEAM_MASTER:", team_master_ncaaf["School"].unique())
